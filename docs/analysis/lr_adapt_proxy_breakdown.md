...
Run analyzed: `20260305T085129Z-cac939ce`

Artifacts:
- `artifacts/runs/high-rigor/20260305T085129Z-cac939ce/results/lr_proxy_cell_breakdown.csv`
- `artifacts/runs/high-rigor/20260305T085129Z-cac939ce/results/lr_proxy_by_noise.csv`
- `artifacts/runs/high-rigor/20260305T085129Z-cac939ce/results/lr_proxy_by_dimension.csv`
- `artifacts/runs/high-rigor/20260305T085129Z-cac939ce/results/lr_proxy_non_significant_cells.csv`
...
| 40 | 12 | -55.557329 | 0.619167 | 11 |

40D behavior is strong in magnitude (`median_of_cell_median_delta = -55.557329`), with 11/12 cells passing BH-FDR `q < 0.05`.

## Non-Significant Cells (1/36)
The only non-significant cell for `lr_adapt_proxy` is:

| function | dimension | noise_sigma | median_delta_vs_vanilla | bh_fdr_q_value |
|---|---:|---:|---:|---:|
| rosenbrock | 40 | 0.0 | -62.479059 | 0.073867 |

It is still directionally favorable (negative median delta), but misses the q-threshold after multiplicity correction.
